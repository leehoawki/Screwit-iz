...
import com.movitech.{{ project }}.interceptor.LogInterceptor;
import com.movitech.{{ project }}.security.CurrentUserHandlerMethodArgumentResolver;
...
public class AppConfig extends WebMvcConfigurerAdapter {
    ...
    public Docket docket() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.movitech.{{ project }}"))
