package org.seeking.{{ project }}.common.collection;
...
public class CollectionUtilTest {
    ...
    public void test() {
        ...
        assertThat(CollectionUtil.<String>getFirst(null)).isNull();
        assertThat(CollectionUtil.getLast(list1)).isNull();
        assertThat(CollectionUtil.<String>getLast(null)).isNull();
    }
    ...
    public void minAndMax() {
        ...
        Assertions.assertThat(CollectionUtil.minAndMax(list).getLeft()).isEqualTo(1);
        Assertions.assertThat(CollectionUtil.minAndMax(list).getRight()).isEqualTo(101);

        Assertions.assertThat(CollectionUtil.minAndMax(list, Ordering.natural()).getLeft()).isEqualTo(1);
        Assertions.assertThat(CollectionUtil.minAndMax(list, Ordering.natural()).getRight()).isEqualTo(101);
    }
