...
public class MapUtilTest {
    ...
    public void generalMethod() {
        ...
        MapUtil.createIfAbsentReturnLast(map2, "haha", new MapUtil.ValueCreator<Integer>() {
            @Override
            public Integer get() {
                return 5;
            }
        ...
        MapUtil.createIfAbsentReturnLast(map2, "haha2", new MapUtil.ValueCreator<Integer>() {
            @Override
            public Integer get() {
                return 5;
            }
