...
public class ClassUtilTest {
    ...
    public void getMessage() {
        ...
        assertThat(ClassUtil.getPackageName(ClassUtilTest.class)).isEqualTo("org.seeking.{{ project }}.common.reflect");
        assertThat(ClassUtil.getPackageName(BClass.class)).isEqualTo("org.seeking.{{ project }}.common.reflect");
        assertThat(ClassUtil.getPackageName(ClassUtilTest.class.getName())).isEqualTo("org.seeking.{{ project }}.common.reflect");
        assertThat(ClassUtil.getPackageName(BClass.class.getName())).isEqualTo("org.seeking.{{ project }}.common.reflect");
    ...
    public void classPresent() {
        ...
        assertThat(ClassLoaderUtil.isPresent("org.seeking.{{ project }}.common.reflect.ClassUtil", ClassLoaderUtil.getDefaultClassLoader()))
                .isTrue();
    }
